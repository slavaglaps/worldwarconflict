  ...
  function build() {
    ...
    el.innerHTML =
      '<div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:5px;">' +
        '<span style="opacity:.85">🏃 Скорость отряда</span>' +
      ...
      '<div style="display:flex;justify-content:space-between;align-items:center;font-size:10px;color:#7d94a6;margin-top:3px;">' +
        '<span>0.02</span>' +
        '<button id="dbgSpeedReset" style="font:10px system-ui;background:#22374a;color:#cfe6f5;border:1px solid #35506a;border-radius:5px;padding:1px 7px;cursor:pointer;">сброс ' + DEF.toFixed(2) + '</button>' +
        '<span>8</span>' +
      '</div>';
